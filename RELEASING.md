...
Use a semantic Git tag such as `v0.3.4`. Drafts and prereleases are not returned
...
bash Scripts/make-release.sh 0.3.4 9
```

The script builds without installing and produces:

- `.release/YUANNotch-0.3.4.zip`
- `.release/YUANNotch-0.3.4.zip.sha256`
- `.release/YUANNotch-0.3.4.md` when release notes were supplied
