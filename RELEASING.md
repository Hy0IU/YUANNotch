...
Use a semantic Git tag such as `v0.3.2`. Drafts and prereleases are not returned
...
bash Scripts/make-release.sh 0.3.2 7
```

The script builds without installing and produces:

- `.release/YUANNotch-0.3.2.zip`
- `.release/YUANNotch-0.3.2.zip.sha256`
- `.release/YUANNotch-0.3.2.md` when release notes were supplied
